...
import Namaz from '../pages/Category/Islamic/Namaz/Namaz';
import IslamicDateConversion from '../pages/Category/Islamic/IslamicDateConversion/IslamicDateConversion';

import MyCalendar from '../pages/Category/TimeDateTools/Calendar';
import PercentageCalculator from '../pages/Category/CalculatorTools/PercentageCalculator';
import Dictionary from '../pages/Category/LanguageTools/Dictionary/Dictionary';
import YoutubeThumbnails from '../pages/Category/UtilityTools/YoutubeThumbnails/YoutubeThumbnails';
                        ...
                        path == 'dictionary' ?
                            ...
                            path == 'percentage-calculator' ?
                                ...
                                path == 'world-calendar' ?
                                    ...
                                    path == 'namaj' ?
                                        <Namaz /> :
                                        path == 'islamic-date-conversion' ?
                                            <IslamicDateConversion /> :
